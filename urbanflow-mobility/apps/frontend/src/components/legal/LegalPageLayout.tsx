      ...
      <main className="mx-auto max-w-[720px] px-6 py-8">
        <article className="legal-content">
          ...
          <ReactMarkdown
            ...
            components={{
              h2: ({ children }) => (
                <h2 className="mb-3 mt-8 text-lg font-bold text-[#0F1B2D] dark:text-text-main">
                  {children}
                </h2>
              ),
              h3: ({ children }) => (
                <h3 className="mb-2 mt-6 text-base font-semibold text-[#0F1B2D] dark:text-text-main">
                  {children}
                </h3>
              ),
              p: ({ children }) => (
                <p className="mb-4 text-base leading-relaxed text-[#0F1B2D] dark:text-text-main">
                  {children}
                </p>
              ),
              ul: ({ children }) => (
